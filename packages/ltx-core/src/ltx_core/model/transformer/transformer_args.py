...
class TransformerArgs:
    ...
    ref_cond_ids: torch.Tensor | None = None  # (B, T) -- 0=main, 1+=ref conds
    _modality_positions: torch.Tensor | None = None  # original positions (rope ref-cond branch)
...
class TransformerArgsPreprocessor:
    ...
    def prepare(
        ...
        return TransformerArgs(
            ...
            ref_cond_ids=modality.ref_cond_ids,
            _modality_positions=modality.positions,
        )
