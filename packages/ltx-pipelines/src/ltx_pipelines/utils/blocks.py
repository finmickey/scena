...
class PromptEncoder:
    ...
    def __init__(
        ...
        embeddings_processor_configurator: type = EmbeddingsProcessorConfigurator,
        embeddings_processor_sd_ops: SDOps = EMBEDDINGS_PROCESSOR_KEY_OPS,
    ) -> None:
        ...
        self._embeddings_processor_builder = Builder(
            model_path=checkpoint_path,
            model_class_configurator=embeddings_processor_configurator,
            model_sd_ops=embeddings_processor_sd_ops,
            registry=registry or DummyRegistry(),
        )
